...
//	[Test]
//	[Order(05)]
//	public void ReturnResult_WithMostFrequentBigrams([Values("x y. x z. x y.", "x z. x y. x y", "x y. x y.", "x y")] string text)
//	{
//		var parsedText = ParseText(text);
//		var expected = new Dictionary<string, string>
//		{
...
//		[Values("x y. x z.", "x z. x y.", "x y. x yy.", "x yy. x y")] string text)
//	{
//		var parsedText = ParseText(text);
//		var expected = new Dictionary<string, string>
//		{
...
//	{
//		return text.Split('.')
//			.Select(sentence => sentence.Split(new[]
//				{
//					' '
...
//			Assert.That(actual[key], Is.EqualTo(expected[key]), $"Input text: [{text}]\nWrong value for key [{key}]");
//		}
